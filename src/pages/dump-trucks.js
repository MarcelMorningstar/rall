        ...
        <Layout>
            ...
            <section>
                ...
                <div className="flex flex-row flex-wrap justify-evenly gap-8">
                    <div className="flex flex-col flex-1 items-center justify-center gap-1">
                        <div className="flex items-center w-auto h-32"><img src="/icons/material1.png" width={120} height={120} alt='rall truck' /></div>
                        <span className="text-2xl font-semibold whitespace-nowrap capitalize text-foreground">{ t("dump-trucks:category1") }</span>
                    </div>
                    <div className="flex flex-col flex-1 items-center justify-center gap-1">
                        <div className="flex items-center w-auto h-32"><img src="/icons/material2.png" width={140} height={140} alt='rall truck' /></div>
                        <span className="text-2xl font-semibold whitespace-nowrap capitalize text-foreground">{ t("dump-trucks:category2") }</span>
                    </div>
                    <div className="flex flex-col flex-1 items-center justify-center gap-1">
                        <div className="flex items-center w-auto h-32"><img src="/icons/material3.png" width={80} height={80} alt='rall truck' /></div>
                        <span className="text-2xl font-semibold whitespace-nowrap capitalize text-foreground">{ t("dump-trucks:category3") }</span>
                    </div>
                    <div className="flex flex-col flex-1 items-center justify-center gap-1">
                        <div className="flex items-center w-auto h-32"><img src="/icons/material4.png" width={110} height={110} alt='rall truck' /></div>
            ...
            <div className="relative grid grid-cols-1 xl:grid-cols-2 items-center xl:items-start gap-8 xl:px-24 py-12">
                <div className="relative w-full h-96">
                    <img src='/images/dump-truck.jpg' className="w-full h-full object-cover" loading="lazy" alt='rall shiping' />
                </div>
